...
class HDF5Dataset(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, root_dir, data_files, verbose=False):
    ...
    def _load_hdf5_file(self, index):
        if index % 1000 == 0 and self.verbose:
...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch SMC Challenge',
...
parser.add_argument('--checkpoint_format', default='./checkpoint-{epoch}.pth.tar',
...
parser.add_argument('--base_lr', type=float, default=0.0125,
...
train_dataset = HDF5Dataset(args.train_dir, train_files, verbose)
